# jpa02-jacobwoodward2000

Repo: https://github.com/ucsb-cs156-s23/jpa02-jacobwoodward2000

Deployed at: https://jpa02h-jacobwoodward.herokuapp.com
...
| `mvn package` | Builds the jar file `target/gs-spring-boot-1.1.0.jar` |
